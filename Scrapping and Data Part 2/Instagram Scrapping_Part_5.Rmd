---
title: "Instagram Scrapping_Part_5"
...
```{r}
movies2 <- data_filtered_3 %>% select(imdb_id, title)

write.csv(movies2, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping and Data Part 2/data_final_movies.csv",row.names = FALSE)
...
nombres <- nombres[!duplicated(nombres$name), ]

write.xlsx(nombres,"C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping and Data Part 2/data_final_actores_full.xlsx",row.Names = FALSE)

```

We will now continue with the Instagram Script and the Youtube Script. They are python scripts called "Instagram Test_Part_6" and "YoutubeScrapping_Part_7". After this scripts we will come back to the R scripts for the last scrapping script called "Scrapping TMDB selected movies_Part_8".
