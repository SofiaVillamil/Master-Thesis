...
movies <- read_delim("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping/TMDB_movie_dataset_v11_1mill_filter.csv", 
    delim = ";", escape_double = FALSE, col_types = cols(release_date = col_date(format = "%d/%m/%Y")), 
    trim_ws = TRUE)

# Select the amount of movies to scrap
test_movies <- head(movies, 55000) 

# Initialize an empty data frame to store results to make less errors
scraped_data <- data.frame()

# Use parallel processing for scraping becuase it takes to long so this will fasten the scrapping process
...
final_data <- left_join(test_movies, scraped_data1, by = "imdb_id")

# Save the final merged dataset
write.csv(final_data, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping/movies_final_dataset_test.csv", row.names = FALSE)
