...
# 1 million movie data set from keggel
movies <- read_delim("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping/TMDB_movie_dataset_v11_1mill.csv", 
    delim = ";", escape_double = FALSE, col_types = cols(release_date = col_date(format = "%d/%m/%Y")), 
    trim_ws = TRUE)

# Select the amount of movies to scrap
test_movies <- head(movies, 58000) 
