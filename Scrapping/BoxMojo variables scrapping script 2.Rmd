...
```{r}
# Load data
movies <- read_csv("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_final_dataset_test.csv",show_col_types = FALSE)
...
# Drop rows where all specified columns are NA becuase they are not found in the site
...
```{r}
write.csv(df_cleaned, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_final_dataset_test_with_bm_cleaned.csv", row.names = FALSE)
```
