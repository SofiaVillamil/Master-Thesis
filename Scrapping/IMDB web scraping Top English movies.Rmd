---
title: "IMDB web scrapping Top English Movies"
...
```{r}
link <- "https://www.imdb.com/chart/top-english-movies/?ref_=chtbtm_ql_4"
```
...
Top_english_movies <- link %>% read_html()
```
...
Top_english_movies <- content(response, "text") %>% read_html()

# Select the movie title nodes
movie_title_nodes <- html_nodes(Top_english_movies, "h3.ipc-title__text")
...
Excel
```{r}
write.csv(movies_df_final, file = "movies_data_Top_english_movies.csv", row.names = FALSE)
```
