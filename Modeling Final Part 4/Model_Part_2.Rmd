...
model_performance <- data.frame(
  Model = c("SVM", "ANN", "Ensemble"),
  MSE = c(0.003591617, 0.003867303, 0.003252143),
  RMSE = c(0.0599301, 0.06218764, 0.05702757),
  MAE = c(0.0299501, 0.02826661, 0.02713093),
  R2 = c(0.1198691, 0.05231185, 0.2030576)
)

# Create the summary table
stargazer(model_performance, type = "text",
          summary = FALSE,
