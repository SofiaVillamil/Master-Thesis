...
```{r}
# Plot observed vs. predicted for the ensemble model
test_set$ensemble_predictions <- ensemble_predictions
ggplot(test_set, aes(x = ensemble_predictions, y = Profit)) +
  geom_point() +
  geom_abline(intercept = 0, slope = 1, colour = "blue") +
  labs(title = "Ensemble Model Observed vs Predicted", x = "Predicted", y = "Observed") +
  theme_minimal()
```
