...
```{r}
movies <- data %>% select(
   title, imdb_id,world_wide_gross,Budget, original_language, production_countries, release_date, MPAA_imdb, Genre_imdb, Duration_mov_imdb, production_companies, 
   
   Director_imdb, FirstActor_imdb, SecondActor_imdb, FirstWriter_imdb, SecondWriter_imdb, AwardsAndNominations_imdb, Oscar_Information_imdb, director_is_woman, lead_is_woman,
