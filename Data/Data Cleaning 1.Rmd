...
```{r}
data <- read_csv("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_test_dataset_with_rotten_tomatoes_cleaned.csv", 
...
```{r}
# Get the class of all variables
...
```{r}
write.csv(na_titles, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/data_na_titles.csv", row.names = FALSE)
...
```{r}
write.csv(movies, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/data_final.csv",row.names = FALSE)

```

Crear data set pequeños para usarlos en el scrapping the python.

```{r}
movies2 <- data %>% select(FirstActor_imdb,title)
movies2 <- movies2 %>% distinct(FirstActor_imdb, .keep_all = TRUE)
write.csv(movies2, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/data_final_actores.csv",row.names = FALSE)

```

```{r}
# Seleccionar las columnas de interés
movies3 <- data %>% select(FirstActor_imdb, SecondActor_imdb)

# Combinar todas las columnas en una sola columna
nombres <- movies3 %>%
  pivot_longer(cols = everything(), names_to = "type", values_to = "nombre") %>%
  select(nombre) %>%
  distinct()

write.csv(nombres, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/data_final_actores_full.csv",row.names = FALSE)
