...
```{r}
# Function to get the gender of the individuals using multiple methods
...
```{r}
# they were corrected using the chat so all names are verified to be correct.
...
# Apply manual corrections to both gender maps
...
# Re-map the genders after corrections
data$director_is_woman <- sapply(data$Director_imdb, map_gender, gender_map = gender_map_directors)
data$lead_is_woman <- sapply(data$FirstActor_imdb, map_gender, gender_map = gender_map_actors)
...
```{r}
write.csv(data, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_test_dataset_with_rotten_tomatoes_cleaned.csv", row.names = FALSE)
