...
rm(list = ls())
```
We are going to use different user agents at random in order to not compromise the web page and the scrapping
```{r}
user_agents <- c(
...
```{r}
data <- read_csv("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_final_dataset_with_bm_cleaned.csv",show_col_types = FALSE)
...
# Example data set to try small number of movies like 2000 and go running it un this chunks of 2000 util you get to 15576. I did it all in but take too long!
...
write_csv(final_data, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Data/movies_test_dataset_with_rotten_tomatoes_cleaned.csv")
