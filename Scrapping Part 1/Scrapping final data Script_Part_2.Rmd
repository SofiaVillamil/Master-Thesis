...
We are going to start by scraping the IMDB data base (Link: <https://www.imdb.com>). We are using the Kaggel data base and filling the data set with more variables.
...
# 1 million movie data set from keggel that is already filtered 
movies <- read_csv("C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping Part 1/TMDB_movie_dataset_v11_1mill_filter.csv", show_col_types = FALSE)
...
# Selecting the amount of movies to scrap in 8 hours
test_movies <- head(movies, 55000) 
...
#write.csv(final_data, "C:/Users/sofia/Documents/Documentos/Master Computational Social Sciences/TFM/Master Thesis/Scrapping and Data Part 2/movies_final_dataset_test.csv", row.names = FALSE)

```

We are now going to continue to the next script called "BoxMojo variables scrapping script_Part_3"
